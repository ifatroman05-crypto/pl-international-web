...
const socialIcons = [
  ...
  { icon: YoutubeIcon, href: siteConfig.socialLinks.youtube, label: "Youtube" },
]
    ...
    <footer className="bg-dark text-light">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <h3 className="mb-5 font-heading text-sm font-semibold uppercase tracking-wider text-gray-300">
              Quick Links
            </h3>
            <ul className="space-y-3">
              {siteConfig.navLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="font-body text-sm text-gray-400 transition-colors hover:text-light"
                  >
                    {link.label}
                  </Link>
                </li>
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-2 px-4 py-5 sm:flex-row sm:px-6 lg:px-8">
          ...
          <p className="font-body text-xs text-gray-500">
            ...
            <a
              href="https://anomalyco.dev"
              target="_blank"
              rel="noopener noreferrer"
              className="underline underline-offset-2 transition-colors hover:text-light"
            >
              Anomaly Co.
            </a>
          </p>
